...
namefoci <- "data_ALE/unhealth.txt"                              # Name of file
space <- "MNI152"                                               # Either MNI or MNI152
...
write.table(file,"NullStudies_unhealth.txt",quote=FALSE,row.names=FALSE,col.names=FALSE)
